//
//  _MiscMergeForeachCommandTests.m
//
...
@interface _MiscMergeForeachCommandTests : MiscMergeTests
@end

@implementation _MiscMergeForeachCommandTests
- (void)setUp
{
    [super setUp];
}
...
- (void)test_handleEndForeachInTemplate
{
